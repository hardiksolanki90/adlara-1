...
class MediaController extends AdminController
{
    ...
    public function initListing(Request $request)
    {
        ...
        if ($request->ajax()) {
          ...
          return json('success', $html, true, prepareHTML($media->paginate(25)->links()));
        }
    ...
    {
        $obj = $this->context->media->find($id);
        if ($obj) {
          $obj->delete();
