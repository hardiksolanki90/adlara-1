...
<div class="con">
  <div class="_tw card">
    ...
    <div class="_tw_w card-body">
      <table class="table table-striped _ft" id="table_new_test">
        <thead>
          <tr>
            <th filter="id">ID</th>
            <th filter="name">Name</th>
            <th filter="status">Status</th>
            <th filter="multi_select">Multi Select</th>
            <th>{{ t('Actions') }}</th>
          </tr>
          <tr class="filter"></tr>
        </thead>
        <tbody class="m-datatable__body">
          @include('new_test/_partials/list-only-new_test')
        </tbody>
      </table>
      <div class="links" table="table_new_test">
        {{ $obj->links() }}
      </div>
