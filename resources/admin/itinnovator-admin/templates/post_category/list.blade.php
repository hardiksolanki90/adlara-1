...
<div class="con">
  <div class="_tw card">
    ...
    <div class="_tw_w card-body">
      <table class="table table-striped _ft" id="table_post_category">
        <thead>
          <tr>
            <th filter="id">ID</th>
        ...
        <tbody class="m-datatable__body">
          @include('post_category/_partials/list-only-post_category')
        </tbody>
      </table>
      <div class="links" table="table_post_category">
        {{ $obj->links() }}
      </div>
