      ...
      <div class="card-body">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#seo" role="tab" data-toggle="tab">SEO</a>
                        ...
                        {!! $form->start('post-create-form', 'myForm tab-pad') !!}
            ...
            <div class="tab-pane container active" id="information">
                      ...
                      {!! $form->text([
                        ...
                        'textarea' => true
                            ...
                            'required' => false,
                            'label' => t('Category'),
                            'value' => $obj->post_category->pluck('id')->toArray(),
                            'class' => '',
                            'options' => $context->post_category->get()->toArray(),
                            'reverse' => true,
                            'text_key' => 'name',
                            'value_key' => 'id',
                            'type' => 'select',
                        ...
                        'multiple' => false                        ]) !!}
                            ...
                            'required' => false,
                            'label' => t('Tag'),
                            'value' => $obj->post_tags->pluck('id')->toArray(),
                            'class' => '',
                            'options' => $context->post_tags->get()->toArray(),
                            'reverse' => true,
                            'text_key' => 'name',
                            'value_key' => 'id',
                            'type' => 'select',
