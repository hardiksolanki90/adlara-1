...
<div class="con">
  <div class="_tw card">
    ...
    <div class="_tw_w card-body">
      <table class="table table-striped _ft" id="table_performance">
        <thead>
          <tr>
            <th filter="id">ID</th>
            <th filter="name">Name</th>
            <th filter="performance-category.name">Categories</th>
            <th filter="performance-dates.name">Date</th>
            <th>{{ t('Actions') }}</th>
          </tr>
          <tr class="filter"></tr>
        </thead>
        <tbody class="m-datatable__body">
          @include('performance/_partials/list-only-performance')
        </tbody>
      </table>
      <div class="links" table="table_performance">
        {{ $obj->links() }}
      </div>
